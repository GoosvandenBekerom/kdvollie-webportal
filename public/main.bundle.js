    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticate(user).subscribe(function (data) {
            ...
            if (data.success) {
                ...
                _this.flashSuccess('U bent succesvol ingelogd');
                _this.router.navigate(['dashboard']);
            }
            else {
                _this.flashDanger(data.msg);
            }
        });
    };
    LoginComponent.prototype.flashDanger = function (message) {
        this.flash.show(message, { cssClass: 'alert-danger', timeout: 5000 });
    };
    LoginComponent.prototype.flashSuccess = function (message) {
...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-dark bg-primary\">\n  <a class=\"navbar-brand\" href=\"#\">Ollie & co</a>\n  <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarMain\" aria-controls=\"navbarMain\" aria-expanded=\"false\" aria-label=\"Toggle navigation\" style=\"\">\n    <span class=\"navbar-toggler-icon\"></span>\n  </button>\n\n  <div class=\"collapse navbar-collapse\" id=\"navbarMain\">\n    <ul class=\"navbar-nav mr-auto\">\n      <li class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact: true}\">\n          <a class=\"nav-link\" [routerLink]=\"['/']\">Home</a>\n      </li>\n    </ul>\n    <ul class=\"navbar-nav ml-auto\">\n        <!-- Not logged in -->\n        <li *ngIf=\"!authService.loggedIn()\" class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact: true}\">\n            <a class=\"nav-link\" [routerLink]=\"['/login']\">Inloggen</a>\n        </li>\n        <li *ngIf=\"!authService.loggedIn()\" class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact: true}\">\n            <a class=\"nav-link\" [routerLink]=\"['/register']\">Registreren</a>\n        </li>\n\n        <!-- Logged in -->\n        <li *ngIf=\"authService.loggedIn()\" class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact: true}\">\n            <a class=\"nav-link\" [routerLink]=\"['/dashboard']\">Dashboard</a>\n        </li>\n        <li *ngIf=\"authService.loggedIn()\" class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact: true}\">\n            <a class=\"nav-link\" [routerLink]=\"['/profile']\">Profiel</a>\n        </li>\n        <li *ngIf=\"authService.loggedIn()\" class=\"nav-item\">\n            <a class=\"nav-link\" href=\"#\" (click)=\"onLogoutClick()\">Uitloggen</a>\n        </li>\n    </ul>\n  </div>\n</nav>\n"
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(authService, flash, router) {
        this.authService = authService;
        this.flash = flash;
        this.router = router;
    }
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.authService.getProfile().subscribe(function (profile) {
            _this.user = __WEBPACK_IMPORTED_MODULE_3__models_User__["a" /* User */].from(profile.user);
        }, function (err) {
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(validateService, authService, flash, router) {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        var _this = this;
        var user = new __WEBPACK_IMPORTED_MODULE_1__models_User__["a" /* User */](this.name, this.email, this.password);
        // Required fields
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashSuccess('Succesfully registered! You can now log in.');
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashDanger('Something went wrong');
            }
        });
    };
    RegisterComponent.prototype.flashDanger = function (message) {
        this.flash.show(message, { cssClass: 'alert-danger', timeout: 5000 });
    };
    RegisterComponent.prototype.flashSuccess = function (message) {
        this.flash.show(message, { cssClass: 'alert-success', timeout: 5000 });
    };
